...
| **[`03a_build_ood_candidate_pools.ipynb`](03a_build_ood_candidate_pools.ipynb)** | Build pinned paper-comparable OOD candidate pools (Dolly broad-text + VQA v2/MSCOCO images) onto Drive, optionally push a private HF dataset, optionally write the unreviewed 150/250 manifest. | Sealed review, generation, judge decisions, or exact upstream inputs. |
